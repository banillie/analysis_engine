...
from analysis.data import root_path, q4_1920, q3_1920
...
master_dm = load_workbook(root_path/'input/commission_dm_master.xlsx')

run = create_master(master_dm, q4_1920.projects, q4_1920, q3_1920)

run.save(root_path/'output/master_1_2021_commission.xlsx')
